...
const HomeSection1 = ({ current, setCurrent, aboutData }) => {
  ...
  return (
    <ResponsiveBox
      classNames="bg-[var(--dialogColor)] min-h-[90vh] items-center justify-center bg-transparent p-20"
      id="about"
      elementRef={homeRef}
    >
      <ConstraintedBox classNames="p-4 pb-16 pt-8 sm:pt-16">
        <WrappedBox classes="justify-items-stretch">
          <Column classes="justify-center">
            ...
            <h1 className="text-[var(--primaryColor)]">{aboutData?aboutData.title:'None'}</h1>

            <p className="font-semibold max-w-sm">{aboutData?aboutData.designation:'Designation'}</p>

            <p className="mt-8 max-w-full sm:max-w-sm md:max-w-md lg:max-w-lg">
              {aboutData?aboutData.description:'Description'}
            </p>
          ...
          <Row classes="w-[20rem] h-[20rem] lg:w-[25rem] lg:h-[25rem] pointer-events-none justify-self-center sm:justify-self-end items-center justify-center rounded-full bg-transparent border-2 border-[var(--primaryColor60)] aspect-sqaure overflow-hidden my-auto mt-[10px] mr-[20px]">
            <Row classes="w-full h-auto items-center justify-center rounded-full bg-transparent border-[0.8rem] border-[var(--primaryColor30)] aspect-sqaure overflow-hidden pointer-events-none">
              <Image
                src={aboutData?aboutData.profile_picture.url:About.avatarUrl}
                alt="profile"
                width={400}
                height={400}
                sizes="100%"
                ...
                fetchPriority="high"
                placeholder="blur"
                blurDataURL={aboutData?aboutData.profile_picture.url:About.avatarUrl}
                style={{
                  objectFit: "cover",
                  width: "100%",
                  height: "100%",
